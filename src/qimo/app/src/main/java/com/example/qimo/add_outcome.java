...
public class add_outcome extends AppCompatActivity {
    ...
    SQLiteOpenHelper helper=new SQLiteOpenHelper(add_outcome.this,"outcome.db",null,1) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent1.setClass(add_outcome.this,outcome.class);
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                db_write.insert("outcome1", null, contentValues);
                ...
                Toast.makeText(add_outcome.this,"保存成功！",Toast.LENGTH_SHORT).show();
            }
        });
    }
}