...
public class change_income extends AppCompatActivity {

    SQLiteDatabase db_read,db_write;
    SQLiteOpenHelper helper=new SQLiteOpenHelper(change_income.this,"income.db",null,1) {
        @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent1.setClass(change_income.this,income.class);
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                db_write.update("income1",contentValues,"id="+tmpID,null);
            }
        });
    }
}
